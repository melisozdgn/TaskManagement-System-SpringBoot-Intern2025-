...
* The system ensures that each user can only view their own projects.

### 2. Task Management
* Users can create tasks within projects and assign them to users.
* Users can update their task status in three different ways: TODO, IN_PROGRESS, and COMPLETED.

### 3. Comment System
* Users can leave comments on assigned tasks through the comment system to facilitate team communication.
* Users can only edit or delete their own comments.

### 4. Authentication & Security
* The system implements JWT-based authorization and authentication to ensure system security.
...
* **Backend:** REST APIs were created on the backend using Java Spring Boot.
...
* **Database:** Data management was achieved with a PostgreSQL database, creating project, task, comment, and user tables.
* **Containerization & Deployment:** Docker was used for containerization and deployment during the development process.
* **Project Tracking:** Jira was used for project planning and task tracking. Sprint-based progress planning was implemented using the Agile methodology.

---

## 🏗️ System Architecture

The backend utilizes a layered architecture, which is the basic component of the system. This architecture facilitates scalability and maintenance, making the system more effective and efficient. 

* **Controller Layer:** Manages API endpoints.
* **Service Layer:** Manages business logic.
* **Repository Layer:** Manages database communication.
* **DTOs (Data Transfer Objects):** Ensure the front end receives only the necessary information.

By using this architecture, code readability and system efficiency have been increased and system security has been fully ensured.
